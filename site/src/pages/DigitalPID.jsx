...
export default function DigitalPID() {
  ...
  return (
    ...
    >
      ...
      <h2 className="text-2xl font-bold text-slate-100 mt-8 mb-3">The Sampling Period (T)</h2>
      ...
      <h2 className="text-2xl font-bold text-slate-100 mt-8 mb-3">Position vs Velocity Algorithm</h2>
      ...
      <h2 className="text-2xl font-bold text-slate-100 mt-8 mb-3">Derivative Filtering</h2>
      ...
      <h2 className="text-2xl font-bold text-slate-100 mt-8 mb-3">Output Rate Limiting</h2>
      ...
      <h2 className="text-2xl font-bold text-slate-100 mt-8 mb-3">Tustin (Bilinear) Discretization</h2>
