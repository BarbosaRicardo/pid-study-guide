...
export default function Lab() {
  ...
  return (
    ...
    >
      ...
      <h2 className="text-2xl font-bold text-navy-700 mt-8 mb-3">Free Simulation Tools</h2>
      ...
      <div className="space-y-4 my-6">
        <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
          <div className="flex items-start gap-4">
            ...
            <div>
              <div className="font-bold text-navy-700">MATLAB/Simulink — Student Edition</div>
              <div className="text-xs text-mblue-600 mb-2">mathworks.com — ~$35/year student license</div>
              <p className="text-sm text-slate-600">The industry standard for control system simulation. Simulink has pre-built PID blocks, process models, and visualization tools. Best choice if you want to match what you'll use professionally. The student edition includes the Control System Toolbox.</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
          <div className="flex items-start gap-4">
            ...
            <div>
              <div className="font-bold text-navy-700">Python — control library + scipy</div>
              <div className="text-xs text-mblue-600 mb-2">pip install control — completely free</div>
              <p className="text-sm text-slate-600">The Python <code>control</code> library implements Bode plots, step responses, and PID simulation. Scipy's ODE solver can simulate arbitrary nonlinear process models. If you're comfortable with Python, this is the most flexible free option.</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
          <div className="flex items-start gap-4">
            ...
            <div>
              <div className="font-bold text-navy-700">CADSIM Plus — Free Process Simulator</div>
              <div className="text-xs text-mblue-600 mb-2">cadsim.com — free tier available</div>
              <p className="text-sm text-slate-600">A process simulation tool specifically designed for process control. Includes models for common unit operations, built-in PID controllers, and trend visualization. Good middle ground between the complexity of Simulink and the simplicity of an Excel spreadsheet.</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
          <div className="flex items-start gap-4">
            ...
            <div>
              <div className="font-bold text-navy-700">Excel PID Simulation Spreadsheet</div>
              <div className="text-xs text-mblue-600 mb-2">Build it yourself — best learning experience</div>
              <p className="text-sm text-slate-600">A discrete-time PID simulation in Excel takes about 30 minutes to build and is the most instructive exercise you can do. When you implement the position algorithm yourself, type in the equations, and watch the plots change as you adjust tuning constants — you internalize the math in a way no textbook achieves.</p>
            </div>
          </div>
        </div>
      </div>

      <h2 className="text-2xl font-bold text-navy-700 mt-8 mb-3">Exercise 1: Build the Excel Simulator</h2>
...
PV[k] = PV[k-1] + (T/tau) * (K * CO[k-delay_steps] - PV[k-1])`}</pre>
      ...
      <h2 className="text-2xl font-bold text-navy-700 mt-8 mb-3">Exercise 2: Python FOPDT Step Response</h2>
...
plt.legend(); plt.grid(); plt.show()`}</pre>
      ...
      <h2 className="text-2xl font-bold text-navy-700 mt-8 mb-3">Exercise 3: Tuning Competition</h2>
      ...
      <h2 className="text-2xl font-bold text-navy-700 mt-8 mb-3">Exercise 4: Valve Stiction Simulation</h2>
