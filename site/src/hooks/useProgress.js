...
const STORAGE_KEY = 'pid_progress_v1'
const PROGRESS_EVENT = 'pid_progress_update'
...
export function useProgress() {
  ...
  const overallProgress = () => {
    const chapters = ['intro', 'loop', 'pid', 'tuning', 'process', 'cascade', 'digital', 'plc', 'troubleshoot', 'lab']
